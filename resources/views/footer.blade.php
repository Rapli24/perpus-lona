<!-- awal FOOTER -->
<div class="col-md-12">
    <div class="row" style="background: rgba(63, 67, 102, 0.562); padding: 20px; color: white;">
        <div class="col-md-9">
            <h3>Visi</h3>
            ...
            <!-- <div class="mt-4">
                <button class="btn btn-primary btn-lg mr-2">Previous</button>
                <button class="btn btn-success btn-lg">Next</button>
            </div> -->
        </div>`
        <div class="col-md-3">
            <p>&copy; 2017. All rights reserved.</p>
            <p>Developed by The Letter</p>
        </div>
    </div>
</div>
<!-- akhir FOOTER -->
